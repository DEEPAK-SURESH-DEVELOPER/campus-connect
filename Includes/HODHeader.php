...
if(isset($_SESSION['hod_id'])) {
    ...
    if($res && $row = $res->fetch_assoc()) {
        ...
        if($photo == "" || strtolower($photo) == "null" || $photo == "0") {
            $photo_path = "../Assets/Files/Teacher/default.png";
        } else {
            $photo_path = "../Assets/Files/Teacher/" . $photo;
        }

        // Final safety fallback: file missing
...
<title><?php echo ($page_title ?? ''); ?> HOD - Campus Connect</title>
