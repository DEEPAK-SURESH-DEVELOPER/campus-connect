...
if(isset($_SESSION['student_id'])) {
    ...
    $qry = "SELECT student_name AS name, student_photo AS photo 
            FROM tbl_student WHERE student_id='$uid'";
    $res = $con->query($qry);
...
<title><?php echo ($page_title ?? ''); ?> Student - Campus Connect</title>
...
=========================== -->
<div id="studentConfirmOverlay" class="custom-confirm-overlay" style="display:none;">
    <div class="custom-confirm-box">
        <h3>Confirm Logout</h3>
        <p>Are you sure you want to logout?</p>

        <div class="confirm-buttons">
            <button class="btn-cancel" onclick="closeStudentConfirm()">Cancel</button>
            <button class="btn-logout" onclick="proceedStudentLogout()">Yes, Logout</button>
        </div>
    </div>
</div>
<!-- =========================== -->
...
<div class="profile-popup" id="profilePopup">
    ...
    <div class="profile-popup-content">
        ...
        <button class="logout-btn" onclick="openStudentLogout()">Logout</button>
...
function openStudentLogout() {
    document.getElementById("studentConfirmOverlay").style.display = "flex";
}

function closeStudentConfirm() {
    document.getElementById("studentConfirmOverlay").style.display = "none";
}

function proceedStudentLogout() {
...
/* ===== CUSTOM CONFIRM BOX (MATCHED TO ADMIN STYLE) ===== */
