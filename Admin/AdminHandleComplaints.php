...
$res = $con->query("SELECT * FROM tbl_complaint WHERE target_type='Admin' ORDER BY complaint_date DESC");

$page_title = "Handle Complaints";
$breadcrumb = '<span>Support</span> <i class="fas fa-chevron-right"></i> <span>Admin Complaints</span>';
...
<div class="main-content">
  <div class="complaint-container">
    <h2 class="complaint-title"><i class="fas fa-exclamation-circle"></i> Complaints to Admin</h2>
